...
AI_EVIDENCE_PATTERNS: tuple[tuple[str, int], ...] = (
    ...
    (r"\bai[- ]powered\b", 5),
    (
        r"\bai\b(?=[\s,-]*(?:platform|model|models|startup|company|software|technology|lab|labs|research|system|systems|capability|capabilities|assistant|agent|agents|product|products))",
        5,
    ),
